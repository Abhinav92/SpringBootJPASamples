...
public final class MyClass {
	...
	public static void main(String[] args) throws IOException {
		...
		try (PDDocument document = new PDDocument()) {
			...
			textBox2.setPartialName("SampleField2");
			...
			textBox2.setDefaultAppearance(defaultAppearanceString);
			...
			widget = textBox2.getWidgets().get(0);
			PDRectangle rect2 = new PDRectangle(150, 1750, 1200, 150);
			...
			textBox2.setValue("New Sample field");
